...
/** Pass scale (e.g. 0.6) to resize. Scales from the bottom-left so bottom alignment stays flush. */
export const ToptalBadge = ({ className = "", scale = 0.65 }) => {
  return (
    <>
      <Head>
      ...
      >
        <div
          className="inline-block bg-[#25a9ef] p-1.5"
          style={{ clipPath: HEX }}
        >
          <div
            className="flex w-[200px] flex-col items-center gap-2 px-0 pb-10 pt-6 text-center text-white"
            style={{
              clipPath: HEX,
              background:
                "linear-gradient(153deg, #0667ff 18%, #204ecf 40%, #0f256e 80%)",
              boxShadow: "0 12px 28px rgba(6, 30, 96, 0.28)",
            }}
          >
            <svg
              width="64"
            ...
            <a
              ...
              className="inline-flex items-center justify-center rounded-md bg-[#296bff] px-5 py-1 text-base font-medium text-white underline decoration-[0.5px] underline-offset-2"
            >
              Hire me
            </a>
          </div>
