...
export default function Articles() {
  return (
    <>
      <Head>
        <title>Ahmad Aslam | Articles - Full Stack Developer</title>
        <meta name="description" content="Browse through Ahmad Aslam's collection of software engineering articles and 
        tutorials on React, React Native, Next.js, full-stack development, AI engineering, and more. 
        Gain valuable insights and stay up-to-date with modern web and mobile development." />
      </Head>
      <TransitionEffect />
      <main
